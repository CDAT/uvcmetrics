...
imagefilename = 'figure-set7_Global_ANN_T_plot-combined.png'
imagethreshold = None
ncfiles = {}
...
ncfiles['figure-set7_Global_ANN_T_plot--model.nc'] = ['rv_T_ANN_ft1_cam_output']
ncfiles['figure-set7_Global_ANN_T_plot--obs.nc'] = ['rv_T_ANN_ft2_obs_atmos_NCEP']
