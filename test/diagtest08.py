...
imagethreshold = None
ncfiles = {}
ncfiles['figure-set8_Global_ANN_T_plot--model.nc'] = ['dv_T_ZonalMean model_ANN_ft1_cam_output']
ncfiles['figure-set8_Global_ANN_T_plot--obs.nc'] = ['dv_T_ZonalMean obs_ANN_ft2_obs_atmos_NCEP']
