...
imagefilename = 'set8_ANN_T-combined.png'
imagethreshold = None
ncfiles = {}
ncfiles['set8_ANN_T--model.nc'] = ['dv_T_ZonalMean model_ANN_ft1_cam_output_model']
ncfiles['set8_ANN_T--obs.nc'] = ['dv_T_ZonalMean obs_ANN_ft2_NCEP_obs']
