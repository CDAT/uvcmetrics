...
imagefilename = 'set15_ANN_T-combined.png'
imagethreshold = None
ncfiles = {}
...
ncfiles['set15_ANN_T--model.nc'] = ['dv_T_Level model_ANN_ft1_cam_output_model']
ncfiles['set15_ANN_T--obs.nc'] = ['dv_T_Level obs_ANN_ft2_NCEP_obs']
