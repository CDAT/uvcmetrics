...
imagefilename = 'figure-set15_Global_ANN_T_plot-combined.png'
imagethreshold = None
ncfiles = {}
ncfiles['T_ANN_model_cam_output.nc'] = ['dv_T_Level model_ANN_ft1_cam_output']
ncfiles['T_ANN_obs_obs_atmos_NCEP.nc'] = ['dv_T_Level obs_ANN_ft2_obs_atmos_NCEP']
