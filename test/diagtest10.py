...
imagefilename = 'figure-set10_Global_ANN_T_plot-combined.png'
imagethreshold = 75
ncfiles = {}
ncfiles['figure-set10_Global_ANN_T_plot-combined--model.nc'] = ['dv_T_obs_ft2_obs_atmos_NCEP', 'dv_T_model_ft1_cam_output']
