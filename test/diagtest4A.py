...
imagethreshold = None
ncfiles = {}
ncfiles['figure-set4A_Global_ANN_T_plot--model.nc'] = ['dv_T_levlon_ANN_ft1_cam35_data_smaller']
ncfiles['figure-set4A_Global_ANN_T_plot--obs.nc'] = ['rv_T_ANN_ft2_obs_NCEP']
