...
imagefilename = 'set13_ANN_CLISCCP-combined-ISCCPCOSP_cam35_data_smaller.png'
imagethreshold = None
ncfiles = {}
...
ncfiles['set13_ANN_CLISCCP-cam35_data_smaller_model.nc'] = ['dv_CLISCCP_ANN_ft1_cam35_data_smaller_model']
ncfiles['set13_ANN_CLISCCP-ISCCPCOSP_obs.nc'] = ['rv_CLISCCP_ANN_Global_ISCCPCOSP']
