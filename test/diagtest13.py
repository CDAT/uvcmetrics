...
imagefilename = 'set13_ANN_CLISCCP-combined.png'
imagethreshold = None
ncfiles = {}
...
ncfiles['set13_ANN_CLISCCP--model.nc'] = ['dv_CLISCCP_ANN_ft1_cam35_data_smaller_model']
ncfiles['set13_ANN_CLISCCP--obs.nc'] = ['rv_CLISCCP_ANN_Global_ISCCPCOSP']
