...
table_row_specs = [ { 'var':'FLUT', 'obs':'CERES-EBAF'} ]#{ 'var':'RESSURF'}, { 'var':'SHFLX_OCN', 'obs':'NCEP'}, { 'var':'TS', 'obs':'NCEP'},{ 'var':'RESTOM'}, {'var':'PRECT', 'obs':'GPCP'} ]#,{ 'var':'RESSURF'} ]#{ 'var':'junk', 'obs':'NCEP'} { 'var':'SWCF', 'obs':'CERES-EBAF'}
