...
diags_collection['2']['RNET'] = {'plottype':'2', 'obs':['NA']}
...
diags_collection['2']['SNOWDP'] = {'plottype':'2', 'obs':['FOSTERDAVY_1 CMC_1']}
...
diags_collection['2']['VWSA'] = {'plottype':'2', 'obs':['MODIS_1']}
...
diags_collection['2']['ASA'] = {'plottype':'2', 'obs':['MODIS_1']}
...
diags_collection['2']['VBSA'] = {'plottype':'2', 'obs':['MODIS_1']}
...
diags_collection['2']['H2OSNO'] = {'plottype':'2', 'obs':['CMC_1']}
...
diags_collection['2']['NWSA'] = {'plottype':'2', 'obs':['MODIS_1']}
...
diags_collection['3']['Snow_vs_Obs'] = {'plottype':'3', 'obs':['CMC_1', 'USAF_1'], 'options':{'twoobs':'yes'}}
...
diags_collection['3']['Total_Precip'] = {'plottype':'3', 'obs':['CMC_1', 'WILLMOTT_1'], 'options':{'twoobs':'yes'}}
diags_collection['3']['Hydrology'] = {'plottype':'3', 'obs':['NA']}
diags_collection['3']['Energy_Moist_Control_of_Evap'] = {'plottype':'3', 'obs':['NA']}
