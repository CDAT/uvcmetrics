...
diags_varlist = OrderedDict()
diags_collection = OrderedDict()
diags_obslist = OrderedDict()
...
diags_collection['topten'] = OrderedDict()
...
# *** Collection 2 ***
diags_collection['2'] = OrderedDict()
...
# *** Collection 3 ***
diags_collection['3'] = OrderedDict()
...
# *** Collection 4 ***
diags_collection['4'] = OrderedDict()
...
# *** Collection 4a ***
diags_collection['4a'] = OrderedDict()
...
diags_collection['5']['ALBEDO'] = {'plottype': '5', 'obs': ['CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['ALBEDOC'] = {'plottype': '5', 'obs': ['CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['FLUT'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['FLUTC'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['FSNTOA'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['FSNTOAC'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['LWCF'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1']}
diags_collection['5']['SWCF'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1', 'CERES2_1', 'CERES_1'], 'regions':['Global', 'Tropics']}
...
diags_collection['5']['TREFHT_LAND'] = {'plottype': '5', 'obs': ['WILLMOTT_1']}
...
# *** Collection 7 ***
diags_collection['7'] = OrderedDict()
...
diags_collection['7']['ICEFRAC'] = {'plottype': '7', 'obs': ['SSMI_1', 'HadISST_1', 'HadISST_PD_1', 'HadISST_PI_1']}
diags_collection['7']['SST'] = {'plottype': '7', 'obs': ['HadISST_1', 'HadISST_PD_1', 'HadISST_PI_1']}
...
# *** Collection 8 ***
diags_collection['8'] = OrderedDict()
...
# *** Collection 9 ***
diags_collection['9'] = OrderedDict()
...
# *** Collection 10 ***
diags_collection['10'] = OrderedDict()
...
diags_collection['10']['T'] = {'plottype': '10', 'obs': ['ECMWF_1', 'JRA25_1', 'AIRS_1', 'ERA40_1', 'NCEP_1'], 'varopts':['850', '200']}
...
diags_collection['10']['Z3'] = {'plottype': '10', 'obs': ['ECMWF_1', 'NCEP_1', 'JRA25_1', 'ERA40_1'], 'varopts':['500', '300']}
diags_collection['10']['TGCLDLWP'] = {'plottype': '10', 'obs': ['SSMI_1', 'NVAP_1']}
diags_collection['10']['ALBEDO'] = {'plottype': '10', 'obs': ['CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['ALBEDOC'] = {'plottype': '10', 'obs': ['CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['FLUT'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['FLUTC'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['FSNTOA'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['FSNTOAC'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
...
diags_collection['10']['LWCF'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
diags_collection['10']['RESTOA'] = {'plottype': '10', 'obs': ['ERBE_1']}
diags_collection['10']['SWCF'] = {'plottype': '10', 'obs': ['ERBE_1', 'CERES2_1', 'CERES_1', 'CERES-EBAF_1']}
...
# *** Collection 11 ***
diags_collection['11'] = OrderedDict()
...
# *** Collection 12 ***
diags_collection['12'] = OrderedDict()
