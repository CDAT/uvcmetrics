...
diags_collection['5']['FLUT'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1']}
diags_collection['5']['FLUTC'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1']}
diags_collection['5']['FSNTOA'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1']}
diags_collection['5']['FSNTOAC'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1']}
diags_collection['5']['LWCF'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1']}
diags_collection['5']['SWCF'] = {'plottype': '5', 'obs': ['ERBE_1', 'CERES-EBAF_1'], 'regions':['Global', 'Tropics']}
...
diags_collection['7']['ICEFRAC'] = {'plottype': '7', 'obs': ['SSMI_1', 'HadISST_CL_1', 'HadISST_PD_1', 'HadISST_PI_1']}
diags_collection['7']['SST'] = {'plottype': '7', 'obs': ['HadISST_CL_1', 'HadISST_PD_1', 'HadISST_PI_1']}
...
diags_collection['10']['ICEFRAC'] = {'plottype': '10', 'obs': ['SSMI_1', 'HadISST_CL_1'], 'regions':['N_Hemisphere_Land', 'S_Hemisphere_Land']}
diags_collection['10']['SST'] = {'plottype': '10', 'obs': ['HadISST_CL_1']}
...
diags_collection['11']['SST'] = {'plottype':'11', 'obs':['HadISST_CL_1']}
