...
collection_special_vars = ['desc', 'preamble', 'mixed_plots', 'mixed_regions', 'regions', 'mixed_seasons', 'seasons', 'mixed_packages', 'packages']
...
diags_collection['dontrun']['mixed_plots'] = True
diags_collection['dontrun']['mixed_regions'] = True
diags_collection['dontrun']['mixed_seasons'] = True
diags_collection['dontrun']['mixed_packages'] = True
diags_collection['dontrun']['desc'] = 'Tier 1B Diagnostics (Southern Ocean)'
diags_collection['dontrun']['preamble'] = ''
diags_collection['dontrun']['seasons'] = ['ANN']
diags_collection['dontrun']['regions'] = ['Global']
diags_collection['dontrun']['packages'] = ['AMWG']
...
diags_collection['dontrun']['PBOT'] = {'plottype':'2', 'obs':['NA_1'], 'packages':['LMWG']}
diags_collection['dontrun']['TSA'] = {'plottype':'2', 'obs':['NA_1'], 'packages':['LMWG']}
# *** Collection 11 ***
diags_collection['11'] = {}
diags_collection['11']['desc'] = 'Pacific annual cycle, Scatter plot plots'
diags_collection['11']['preamble'] = ''
diags_collection['11']['seasons'] = ['ANN']
diags_collection['11']['packages'] = ['AMWG']
# *** Collection 10 ***
diags_collection['10'] = {}
diags_collection['10']['desc'] = 'Annual cycle line plots of global means'
diags_collection['10']['preamble'] = ''
diags_collection['10']['seasons'] = ['ANN']
diags_collection['10']['mixed_regions'] = True
diags_collection['10']['regions'] = ['Global']
diags_collection['10']['packages'] = ['AMWG']
...
diags_collection['10']['CLDTOT_VISIR'] = {'plottype': '10', 'obs': ['ISCCP_1']}
...
diags_collection['10']['CLDHGH_VISIR'] = {'plottype': '10', 'obs': ['ISCCP_1']}
diags_collection['10']['EP'] = {'plottype': '10', 'obs': ['ECMWF_1', 'ERA40_1']}
diags_collection['10']['CLDMED_VISIR'] = {'plottype': '10', 'obs': ['ISCCP_1']}
...
diags_collection['13']['preamble'] = ''
diags_collection['13']['packages'] = ['AMWG']
# *** Collection 12 ***
diags_collection['12'] = {}
diags_collection['12']['desc'] = 'Vertical profile plots from 17 selected stations'
diags_collection['12']['preamble'] = ''
diags_collection['12']['packages'] = ['AMWG']
# *** Collection 15 ***
diags_collection['15'] = {}
diags_collection['15']['desc'] = 'Annual Cycle at Select Stations plots'
diags_collection['15']['preamble'] = ''
diags_collection['15']['seasons'] = ['ANN']
diags_collection['15']['packages'] = ['AMWG']
...
diags_collection['3']['CLDTOT_VISIR'] = {'plottype': '3', 'obs': ['ISCCP_1']}
...
diags_collection['3']['CLDHGH_VISIR'] = {'plottype': '3', 'obs': ['ISCCP_1']}
diags_collection['3']['PREH2O'] = {'plottype': '3', 'obs': ['NCEP_1', 'NVAP_1', 'JRA25_1', 'ERA40_1', 'MODIS_1', 'ECMWF_1', 'AIRS_1', 'SSMI_1']}
diags_collection['3']['CLDMED_VISIR'] = {'plottype': '3', 'obs': ['ISCCP_1']}
...
diags_collection['3']['CLDLOW_VISIR'] = {'plottype': '3', 'obs': ['ISCCP_1']}
...
diags_collection['1']['preamble'] = ''
diags_collection['1']['seasons'] = ['DJF', 'JJA', 'ANN']
diags_collection['1']['packages'] = ['AMWG']
# *** Collection so (southern ocean) ***
diags_collection['so'] = {}
diags_collection['so']['mixed_plots'] = True
diags_collection['so']['mixed_regions'] = True
diags_collection['so']['mixed_seasons'] = True
diags_collection['so']['desc'] = 'Tier 1B Diagnostics (Southern Ocean)'
diags_collection['so']['preamble'] = ''
diags_collection['so']['seasons'] = ['ANN']
diags_collection['so']['regions'] = ['Global']
diags_collection['so']['packages'] = ['AMWG']
...
diags_collection['topten']['preamble'] = ''
diags_collection['topten']['seasons'] = ['ANN']
diags_collection['topten']['packages'] = ['AMWG']
...
diags_collection['2']['seasons'] = ['ANN']
...
diags_collection['2']['packages'] = ['AMWG']
...
diags_collection['5']['preamble'] = ''
diags_collection['5']['seasons'] = ['DJF', 'JJA', 'ANN']
diags_collection['5']['mixed_regions'] = True
diags_collection['5']['regions'] = ['Global']
diags_collection['5']['packages'] = ['AMWG']
...
diags_collection['5']['CLDTOT_VISIR'] = {'plottype': '5', 'obs': ['ISCCP_1']}
...
diags_collection['5']['CLDHGH_VISIR'] = {'plottype': '5', 'obs': ['ISCCP_1']}
diags_collection['5']['EP'] = {'plottype': '5', 'obs': ['ECMWF_1']}
diags_collection['5']['CLDMED_VISIR'] = {'plottype': '5', 'obs': ['ISCCP_1']}
...
diags_collection['5']['CLDLOW_VISIR'] = {'plottype': '5', 'obs': ['ISCCP_1']}
...
diags_collection['4']['preamble'] = ''
diags_collection['4']['seasons'] = ['DJF', 'JJA', 'ANN']
diags_collection['4']['packages'] = ['AMWG']
...
diags_collection['7']['packages'] = ['AMWG']
...
diags_collection['9']['preamble'] = ''
diags_collection['9']['packages'] = ['AMWG']
...
diags_collection['8']['preamble'] = ''
diags_collection['8']['seasons'] = ['ANN']
diags_collection['8']['packages'] = ['AMWG']
...
diags_collection['4a']['preamble'] = ''
diags_collection['4a']['seasons'] = ['DJF', 'JJA', 'ANN']
diags_collection['4a']['packages'] = ['AMWG']
